...
<div class="form-group row">
    <div class="col-sm-10">
        <input type="number" name="codigo" class="form-control" value="<?= $_GET['codigo'] ?>" placeholder="Informe o codigo para consultar">
    </div>
    <div class="col-sm-2">
...
<form action="#" method="post">
    ...
    <div class="form-row">
        <div class="form-group col-md-9">
            ...
            id="nome" name="nome" placeholder="Nome" value="<?= $dados['nome'] ?>">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            id="email" name="email" placeholder="E-mail" value="<?= $dados['email'] ?>">
            <div class="invalid-feedback">
                <?= $erros['email'] ?>
            </div>
        </div>
        <div class="form-group col-md-6">
            ...
            id="site" name="site" placeholder="Site" value="<?= $dados['site'] ?>">
            <div class="invalid-feedback">
                <?= $erros['site'] ?>
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            id="filhos" name="filhos" placeholder="Qtde de Filhos" value="<?= $dados['filhos'] ?>">
            <div class="invalid-feedback">
                <?= $erros['filhos'] ?>
            </div>
        </div>
        <div class="form-group col-md-6">
            ...
            id="salario" name="salario" placeholder="Salário" value="<?= $dados['salario'] ?>">
            <div class="invalid-feedback">
                <?= $erros['salario'] ?>
            </div>
        </div>
